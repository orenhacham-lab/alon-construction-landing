...
/** איור אדריכלי וקטורי - משמש כ-placeholder עד להעלאת תמונת Hero אמיתית */
function HeroBuildingSvg({ className }: { className?: string }) {
  return (
    <svg
      viewBox="0 0 560 600"
      className={className}
...
/**
 * ויזואל ה-Hero: תמונה אמיתית של בניין בשיקום (אם הועלתה ל-/public/images/),
 * אחרת איור אדריכלי מקצועי. בתוספת תגיות אמון צפות.
 */
    ...
    <div className="relative mx-auto w-full max-w-[560px]">
      ...
      <div className="relative aspect-[14/15] w-full">
        <ImageWithFallback
          ...
          alt="בניין מגורים בתהליך שיקום עם פיגומים"
          eager
          imgClassName="absolute inset-0 h-full w-full rounded-3xl object-cover shadow-2xl ring-1 ring-white/10"
          fallback={<HeroBuildingSvg className="absolute inset-0 h-full w-full drop-shadow-2xl" />}
        />
      </div>
